...
$query = "SELECT * FROM lokasi WHERE id_lokasi = ?";
...
if ($result->num_rows == 0) {
    echo "Data Lokasi toko tidak ditemukan.";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $id_lokasi = $_POST['nama'];
    $nama_toko = $_POST['deskripsi'];
    $alamat = $_POST['kecamatan'];
    $jam_operasional = $_POST['lat'];
    $kategori_produk = $_POST['lng'];
    ...
    if ($update_stmt->execute()) {
        echo "<script>alert('Data Lokasi toko berhasil diperbarui!'); window.location.href = 'data_lokasi.php';</script>";
    } else {
        echo "<script>alert('Gagal memperbarui data lokasi toko.');</script>";
    }
}
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content pt-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
    <h1 class="text-center">Edit Lokasi Toko</h1>
    <form method="post" action="">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="kecamatan" name="kecamatan" required><?= htmlspecialchars($row['kecamatan']) ?></textarea>
        </div>
        <div class="form-group">
            <label for="lat">Latitude</label>
            <input type="text" class="form-control" id="lat" name="lat" value="<?= htmlspecialchars($row['lat']) ?>" required>
        </div>
        <div class="form-group">
            <label for="lng">Longitude</label>
            <input type="text" class="form-control" id="lng" name="lng" value="<?= htmlspecialchars($row['lng']) ?>" required>
        </div>
