...
<head>
    ...
    <title>Data Galeri Laptop</title>
    <!-- AdminLTE 3 CDN -->
    ...
    <div class="content-wrapper">
        <section class="content pt-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h1>Data Galeri Laptop</h1>
                        <a href='tambah_laptop.php' class='btn btn-primary btn-sm'>Tambah Data</a>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama Laptop</th>
                                    <th>Foto Laptop</th>
                                    <th>Deskripsi Laptop</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php include 'load_laptop.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
